        ...
        <div className="card !bg-white/30 !p-2.5 shadow-cardHover text-sm">
          {success ? (
            <div className="text-center">
              <h1 className="text-xs font-bold text-brand-black">{t.signup.successTitle}</h1>
            ...
            <>
              <h1 className="text-xs font-bold text-brand-black">{t.signup.title}</h1>
              <p className="mt-0.5 text-[10px] text-brand-gray">{t.signup.subtitle}</p>

              <form onSubmit={handleSubmit} className="mt-1.5 space-y-1">
                <div>
                  <label htmlFor="fullName" className="label-field !mb-0.5 !text-[10px]">
                    {t.signup.fullName}
                  </label>
                  <input
                    id="fullName"
                ...
                <div className="grid grid-cols-2 gap-1">
                  <div>
                    <label htmlFor="employeeCode" className="label-field !mb-0.5 !text-[10px]">
                  ...
                  <div>
                    <label htmlFor="project" className="label-field !mb-0.5 !text-[10px]">
                      {t.signup.project}
                    </label>
                    <select
                      id="project"
                ...
                <div>
                  <label htmlFor="confirmPassword" className="label-field !mb-0.5 !text-[10px]">
